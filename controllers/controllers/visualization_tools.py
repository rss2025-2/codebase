...
class VisualizationTools:
    ...
    @staticmethod
    def visualize_wall(wall_params, publisher, color = (0.0, 0.0, 1.0), frame = '/base_link'):
        (slope, offset), _ = wall_params
        VisualizationTools.plot_line([-1.0*slope+offset, 1.0*slope+offset], [1.0, -1.0], publisher, color, frame)